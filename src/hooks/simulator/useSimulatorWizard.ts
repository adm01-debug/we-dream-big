...
export function useSimulatorWizard() {
  ...
  // QA: dispatch é estável (useCallback([]) dentro de useUndoableReducer), mas
  // exhaustive-deps não infere isso de hook customizado — incluímos nas deps
  // para satisfazer a regra sem mudar o comportamento.
  useEffect(() => {
