...
export {
  ...
  type CategoryNode,
  type CategoryOption as CategoryTreeOption,
} from '@/hooks/products/useCategoriesTree';
...
export type { SupplierOption as SuppliersHookOption } from '@/hooks/products/useSuppliers';
