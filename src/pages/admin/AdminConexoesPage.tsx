        ...
        <CredentialsSourceFilterProvider>
          <div className="mx-auto w-full max-w-[1920px] animate-fade-in space-y-3 px-3 py-3 pb-24 sm:space-y-4 sm:px-4 sm:py-4 md:pb-6 lg:px-6 xl:px-8">
            <PageSEO
              ...
              description="Hub central de integrações externas: Supabase, Bitrix24, n8n, MCP, Webhooks, AI Router."
            />
            ...
            <header className="flex items-center gap-3 border-b border-border/40 pb-2">
              ...
              <div className="flex-1">
                <h1 data-testid="page-title-conexoes" className="text-2xl font-bold tracking-tight">
                  Conexões
                </h1>
