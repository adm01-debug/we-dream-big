  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'text-tooltip grid min-w-[8rem] items-start gap-2 rounded-lg border border-white/10 bg-black/85 px-3 py-2.5 text-xs text-white shadow-2xl backdrop-blur-md',
          className,
        )}
      >
