  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'text-tooltip grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/40 bg-foreground/90 px-2.5 py-1.5 text-xs text-background shadow-sm backdrop-blur-sm',
          className,
        )}
      >
