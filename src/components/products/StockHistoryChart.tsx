        ...
        <div className="h-[160px] sm:h-[200px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={chartData} margin={{ top: 5, right: 5, left: 0, bottom: 5 }}>
              ...
              <Tooltip content={({ active, payload }: { active?: boolean; payload?: { payload: Record<string, number> }[] }) => (
...
function MarketTooltip({ active, payload, showCost }: { active?: boolean; payload?: { payload: Record<string, number> }[]; showCost: boolean }) {
