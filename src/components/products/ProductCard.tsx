    ...
    return (
      <article
        ...
        className={cn(
          ...
          hasHighlightedColor
            ? 'border-2'
            : 'border-[1.5px] border-primary/20 hover:border-primary/50 hover:shadow-xl',
        )}
        style={
      ...
      >
        ...
        <div
          className={cn(
            'relative space-y-2 p-2.5 transition-all duration-500 sm:space-y-3 sm:p-4',
            isHovered ? 'translate-y-[-4px] bg-card/95 backdrop-blur-md' : 'bg-card',
          )}
          style={{ zIndex: 10 }}
        >
          {!hideCategoryBadges && (
