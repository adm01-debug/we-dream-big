...
export function AppLogo({ 
  ...
  const iconBg = variant === 'brand' ? 'bg-white' : variant === 'light' ? 'bg-white' : 'bg-foreground';
  const iconColor = variant === 'brand' ? 'text-primary' : variant === 'light' ? 'text-foreground' : 'text-background';
