...
export const TECHNIQUE_FILTERS: Record<string, TechniqueFilter> = {
  bordado: { filter: "contrast(1.1) saturate(0.9)", opacity: 0.85, description: "Textura de bordado" },
  ...
  laser: { filter: "grayscale(1) contrast(1.3) sepia(0.3)", opacity: 0.7, description: "Gravação laser" },
  laser_co2: { filter: "grayscale(1) contrast(1.2) sepia(0.4) brightness(0.9)", opacity: 0.75, description: "Laser CO2" },
  laser_fibra: { filter: "grayscale(1) contrast(1.4) brightness(1.1)", opacity: 0.8, description: "Laser Fibra" },
  sublimacao: { filter: "saturate(1.3) brightness(1.05)", opacity: 0.92, description: "Sublimação" },
  tampografia: { filter: "contrast(1.15)", opacity: 0.88, description: "Tampografia" },
  hot_stamping: { filter: "sepia(0.5) saturate(1.5) brightness(1.2) contrast(1.1)", opacity: 0.85, description: "Hot Stamping" },
  adesivo: { filter: "brightness(1.02)", opacity: 0.95, description: "Adesivo" },
  uv: { filter: "contrast(1.1) saturate(1.15) brightness(1.05)", opacity: 0.9, description: "Impressão UV" },
...
export function getTechniqueFilter(techniqueCode?: string | null, techniqueName?: string): TechniqueFilter {
