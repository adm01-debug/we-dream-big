...
export function useProductGroups() {
  ...
  const addGroup = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ["product-groups"] }); toast.success("Grupo criado!"); },
  ...
  const updateGroup = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ["product-groups"] }); toast.success("Grupo atualizado!"); },
  ...
  const deleteGroup = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ["product-groups"] }); toast.success("Grupo removido!"); },
  ...
  const addMember = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ["product-group-members"] }); toast.success("Produto adicionado ao grupo!"); },
  ...
  const removeMember = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ["product-group-members"] }); toast.success("Produto removido do grupo!"); },
    onError: () => toast.error("Erro ao remover produto"),
  });

  const getMembersForGroup = (groupId: string) => groupMembers?.filter(m => m.product_group_id === groupId) || [];
  ...
  return {
    groups, groupsLoading, allProducts, groupMembers,
