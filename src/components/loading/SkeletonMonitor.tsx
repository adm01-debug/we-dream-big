...
export function SkeletonMonitor({
  ...
  // Skeletons são UI pura e podem renderizar fora de um AuthProvider (ex.:
  // fallbacks de <Suspense> em testes/SSR). Lemos o contexto defensivamente
  // para que o overlay dev-only seja apenas suprimido, sem derrubar a árvore.
