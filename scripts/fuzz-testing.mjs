...
const generateRandomPayload = () => {
  ...
  switch (type) {
    case 'sql':
      return { query: "' OR '1'='1", table: 'users; DROP TABLE products;--' };
    case 'xss':
      return { html: '<img src=x onerror=alert(1)>', content: 'javascript:alert(1)' };
    case 'overflow':
      return { data: 'A'.repeat(50000) };
    case 'null':
      return { data: null, items: [null, undefined] };
    case 'invalid_json':
      return '{ malformed: [json ';
    case 'type_mismatch':
      return { id: true, amount: 'not-a-number', items: {} };
    default:
      return {};
  }
};
