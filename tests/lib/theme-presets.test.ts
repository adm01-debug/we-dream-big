...
// HSL derivado do Zapp Web, com lightness ajustada em alguns skins para atingir
// contraste WCAG (ver comentários em src/lib/theme-presets.ts). Manter
// sincronizado com os valores reais dos presets.
