-- ============================================================================
-- Fix: audit_ownership_orphans tentava cast ::uuid em colunas TEXT, quebrava
...
--
-- Data: 15/mai/2026
-- Bug detectado: ownership-audit edge function retornava HTTP 500 com
--                "invalid input syntax for type uuid: \"system\""
-- Causa raiz: enriched_contacts.created_by é TEXT com 48 linhas de "system".
-- ============================================================================
